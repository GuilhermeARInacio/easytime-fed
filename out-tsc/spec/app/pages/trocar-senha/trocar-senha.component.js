...
let TrocarSenhaComponent = class TrocarSenhaComponent {
    usuarioService;
    popUpService;
    router;
    formBuilder;
    ...
    showPassword = false;
    email = null;
    constructor(usuarioService, popUpService, router, formBuilder, route) {
            ...
            this.usuarioService.trocarSenha(trocarSenha).subscribe({
                ...
                error: (err) => {
                    ...
                    if (err.status === 401) {
                        ...
                        this.error = err.error || 'Desculpe, ocorreu um erro ao tentar trocar a senha, tente novamente mais tarde.';
                    }
                    this.abrirNotificacao({
                        titulo: 'Erro',
                        mensagem: this.error ?? '',
