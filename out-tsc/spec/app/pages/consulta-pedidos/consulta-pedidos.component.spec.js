...
describe('ConsultaPedidosComponent', () => {
    ...
    it('deve abrir o modal de alteração e definir o pedido e overflow hidden no body', () => {
        ...
        const component = new ConsultaPedidosComponent({}, {}, {}, {}, rendererSpy, elementMock);
        ...
        component.abrirModalAlteracao(pedidoMock);
    ...
    it('deve exibir erro de login expirado e chamar sair ao receber erro 401', (done) => {
        pontoServiceSpy.consultarPedidos.and.returnValue(throwError(() => ({
            status: 401,
    ...
    it('deve exibir erro interno ao receber erro 500', (done) => {
        pontoServiceSpy.consultarPedidos.and.returnValue(throwError(() => ({
            status: 0,
            error: 'Desculpe, ocorreu um erro interno ao tentar consultar os pedidos. Tente novamente mais tarde.',
        })));
        component.consultar();
        setTimeout(() => {
